...
let deleteTask = async () => {
    ...
    let deletedTask = todosList.splice(taskIndex.index - 1, 1);
...
let updateTask = async () => {
    ...
    console.log('\n Task at index no. ${update_task_index -1} updated sucessfully [For updated list check option: "view Todo-List"] ');
};
main();
